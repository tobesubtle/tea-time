...
## [완료] 모바일 상단 헤더 가시성 개선 및 전역 '모바일로 보기 / PC로 보기' 모드 전환 기능
## [완료] 동적 오픈그래프(Open Graph) 썸네일 카드 및 SEO 메타데이터 설정 ([app/opengraph-image.tsx](file:///c:/Users/niceg/OneDrive/문서/Antigravity/my-prompt/app/opengraph-image.tsx))
